...
public abstract class AbstractContext
{
    ...
    protected Dictionary<string, Func<DynamicContext, ExecutionParameters, ISequence>> registeredVariableDeclarationByHashKey;
    ...
    public Dictionary<string, Func<DynamicContext, ExecutionParameters, ISequence>> RegisteredVariableDeclarationByHashKey => registeredVariableDeclarationByHashKey;
    public abstract FunctionProperties? LookupFunction(string namespaceURI, string localName, int arity, bool skipExternal);
