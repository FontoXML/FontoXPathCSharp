...
public static class ParsingFunctions
{
    ...
    public static ParseFunc<TR> Then4<T1, T2, T3, T4, TR>(ParseFunc<T1> parser1,
        ParseFunc<T2> parser2, ParseFunc<T3> parser3, ParseFunc<T4> parser4,
        Func<T1, T2, T3, T4, TR> join)
    {
        return Then(
            Then(
                Then(parser1, parser2, (a, b) => (a, b)),
                parser3,
                (ab, c) => (ab.a, ab.b, c)
            ),
            parser4,
    ...
    public static ParseFunc<TR> Then5<T1, T2, T3, T4, T5, TR>(ParseFunc<T1> parser1,
        ParseFunc<T2> parser2, ParseFunc<T3> parser3, ParseFunc<T4> parser4, ParseFunc<T5> parser5,
